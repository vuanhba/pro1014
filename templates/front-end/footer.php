<footer class="dark-footer skin-dark-footer">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-4">
								<div class="footer-widget">
									<img src="public/layout/assets/img/logo-light.png" class="img-footer" alt="" />
		...
		<script src="public/layout/assets/js/rangeslider.js"></script>
		<script src="public/layout/assets/js/select2.min.js"></script>
		<script src="public/layout/assets/js/jquery.magnific-popup.min.js"></script>
		<script src="public/layout/assets/js/slick.js"></script>
		<script src="public/layout/assets/js/slider-bg.js"></script>
		<script src="public/layout/assets/js/lightbox.js"></script> 
		<script src="public/layout/assets/js/imagesloaded.js"></script>
		 
		<script src="public/layout/assets/js/custom.js"></script>
		<script src="public/layout/assets/js/cl-switch.js"></script>
		<!-- ============================================================== -->
		<!-- This page plugins -->
		<!-- ============================================================== -->
